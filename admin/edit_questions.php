...
<html class="fixed">
 ...
 <?php
                if(isset($_GET['id'])){
        $edit = $_GET['id'];
    $query = "SELECT * FROM chatbot_hints where id ='$edit'";
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input class="form-control" id="reply" name="reply" value="<?php echo $reply;?>" type="text" >
												</div>
											</div>
...
$sql = "Update chatbot_hints set questions='$question2', reply = '$reply2' where id = '$update_id' ";
